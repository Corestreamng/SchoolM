...
export default function ResultViewPage() {
  ...
  const resultId = params?.id ? parseInt(params.id as string) : 0;
      ...
      <div ref={printRef} className="bg-white p-8 border rounded-lg">
        ...
        <div className="header-section mb-6">
          <div className="relative flex items-start justify-center mb-4">
            ...
            <div className="text-center flex-1">
              ...
              <p className="text-lg font-semibold">PUPIL'S REPORT SHEET</p>
            </div>
          ...
          <div className="text-center">
            <p className="text-xl font-bold">{result.term.toUpperCase()}</p>
          </div>
        </div>
            ...
            <div className="space-y-3">
              ...
              <div>
                <p className="text-sm leading-relaxed">
                  ...
                  <span className="font-semibold">08TH NOVEMBER, 2025</span>
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div>
                <p className="text-sm leading-relaxed">
                  ...
                  :{" "}
                  <span className="font-semibold">{result.academic_year}</span>
                </p>
              </div>
              <div>
                <p className="text-sm leading-relaxed">
          ...
          <table className="w-full border-collapse border border-black text-sm">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border border-black p-2">EXAM | الإمتحان</th>
                <th className="border border-black p-2">TOTAL | المجموع</th>
                <th className="border border-black p-2">POSITION | الترتيب</th>
                <th className="border border-black p-2">GRADE | لدرجة</th>
                <th className="border border-black p-2">REMARKS | ملاحظات</th>
              </tr>
            </thead>
            <tbody>
              {result.subject_scores?.map((score, index) => {
                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="border border-black p-2">
                      <span
                        className={`grade-badge grade-${grade} px-2 py-1 rounded text-white text-xs font-bold`}
                      >
                        {grade}
                      </span>
                    </td>
              ...
              <tr className="bg-gray-50 font-bold">
                ...
                <td className="border border-black p-2">{stats.totalScore}</td>
                <td colSpan={4} className="border border-black p-2"></td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="stats grid grid-cols-2 gap-4 mb-6 pt-4 border-t-2 border-black">
          ...
          <div className="stat-item">
            ...
            <p className="stat-value text-2xl font-bold">{stats.totalScore}</p>
          </div>
        </div>
